...
from xray.storage import save_execution, list_executions, load_execution
from demo.mock_data import get_reference_product, get_mock_search_results
from demo.demo_app import (
    generate_keywords,
    evaluate_product,
    evaluate_relevance,
    rank_and_select
            ...
            with xray.step("apply_filters", step_type="filter",
                ...
                with step.evaluation_stream() as stream:
                    for product in candidates:
                        evaluation = evaluate_product_with_params(
                            product, 
                            reference_product,
                            min_price_mult,
                            max_price_mult,
...
def evaluate_product_with_params(product: dict, reference_product: dict,
